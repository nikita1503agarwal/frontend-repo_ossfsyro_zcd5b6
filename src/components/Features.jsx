...
function Features() {
  ...
  return (
    <div className="max-w-6xl mx-auto px-6 mt-20 grid sm:grid-cols-3 gap-6">
      {items.map((it, i) => (
        <motion.div
          key={i}
          ...
          className={`rounded-2xl p-[1px] bg-gradient-to-r ${it.color}`}
        >
          <div className="bg-white/5 border border-white/15 rounded-2xl p-6 text-sky-50 backdrop-blur shadow-xl shadow-sky-900/30">
            <div className="w-10 h-10 rounded-full bg-white/10 border border-white/20 flex items-center justify-center text-sky-100">
              {it.icon}
            </div>
